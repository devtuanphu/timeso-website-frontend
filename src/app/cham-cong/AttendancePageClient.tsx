            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="mx-auto mb-8 max-w-lg text-[14px] leading-relaxed text-[#475467] md:text-lg lg:mx-0">
                  Hệ thống Timeso theo dõi giờ làm, công suất và hiệu suất liên tục của từng nhân
                  viên theo thời gian thực, giúp bạn nhanh chóng nắm bắt biến động, tối ưu quy trình
                  và giảm thiểu sai sót trong quản lý.
                </p>
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2 text-[14px] leading-relaxed text-[#475467] md:text-[16px]">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#475467]" />
                      <span>
                        Dữ liệu được đồng bộ theo thời gian thực, giúp quản lý nắm bắt tình trạng
                        nhân sự mọi lúc.
                      </span>
                    </li>
                  </ul>
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2 text-[14px] leading-relaxed text-[#475467] md:text-[16px]">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#475467]" />
                      <span>
                        Mọi thay đổi được cập nhật tức thì, đảm bảo quy trình vận hành nhanh chóng
                        và chính xác.
                      </span>
                    </li>
                  </ul>
